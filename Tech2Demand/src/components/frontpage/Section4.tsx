...
const Section4: React.FC = () => {
    return (
        <section className="relative w-full overflow-hidden bg-[#050814] text-white pt-28 pb-32 font-sans border-t border-white/5">
            ...
            {/* Sparkles Layer */}
            <div className="absolute inset-0 bg-sparkles opacity-60 pointer-events-none"></div>

            {/* Left Purple Glow */}
            <div className="absolute top-[10%] -left-[300px] w-[600px] h-[600px] bg-[#9a42ff] rounded-full blur-[150px] opacity-[0.12] pointer-events-none"></div>
            
            {/* Right Blue Glow */}
            <div className="absolute top-[20%] -right-[300px] w-[600px] h-[600px] bg-[#4f7cff] rounded-full blur-[150px] opacity-[0.1] pointer-events-none"></div>
            ...
            <svg className="absolute bottom-0 left-0 w-[45%] h-[70%] pointer-events-none opacity-30" viewBox="0 0 600 600" preserveAspectRatio="none">
            ...
            <svg className="absolute bottom-0 right-0 w-[45%] h-[70%] pointer-events-none opacity-30" viewBox="0 0 600 600" preserveAspectRatio="none">
            ...
            <div className="relative z-10 w-full px-6 md:px-[60px] lg:px-[100px] mx-auto flex flex-col items-center">
                ...
                {/* Feature Row (5 Items) */}
                <div className="mt-24 w-full flex flex-col lg:flex-row items-stretch justify-center relative">
                    
                    {/* Item 1 */}
                    <div className="flex-1 flex flex-col items-center text-center px-4 lg:px-6 py-8 lg:py-0">
                ...
                {/* Bottom CTA Panel */}
                <div className="mt-24 w-full max-w-[76rem] rounded-[2.5rem] bg-gradient-to-br from-white/[0.04] to-transparent border border-white/[0.08] p-10 lg:p-14 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16 shadow-[0_0_80px_rgba(166,77,255,0.06)] relative overflow-hidden backdrop-blur-sm">
